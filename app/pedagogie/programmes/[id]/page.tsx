...
import { ArrowLeft, BookOpen, ChevronDown, Plus, Save } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#F7F8FC] p-6 lg:p-8">
      ...
      <header className="mb-7 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          ...
          <span className="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-600">{program.status}</span>
        </div>
      </header>
