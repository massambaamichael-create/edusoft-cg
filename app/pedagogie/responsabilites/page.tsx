...
export default function PedagogicalResponsibilitiesPage() {
  ...
  return <main className="min-h-full bg-[#F6F7FB] px-5 py-7 lg:px-10 lg:py-9"><div className="mx-auto max-w-7xl space-y-6">
    ...
    <section className="rounded-[24px] border border-slate-200/80 bg-white shadow-[0_14px_45px_-28px_rgba(15,23,42,0.35)]"><div className="flex items-center gap-3 border-b p-5"><BookOpen className="h-5 w-5 text-indigo-600"/><div><h2 className="font-semibold text-slate-900">Responsables de matière</h2><p className="text-sm text-slate-500">Responsabilité par matière et contexte, avec ciblage possible du niveau ou de la série/filière.</p></div></div>
